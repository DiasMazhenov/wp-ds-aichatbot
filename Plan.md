...
Версия `0.5.22` объединяет отдельный AI FAQ с экраном «База знаний». На единой странице доступны структурированные записи, ручной текст на 10 строк, переиндексация сайта и PDF-источники; отдельный пункт FAQ удалён из меню.
