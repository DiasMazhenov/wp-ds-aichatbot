...
Версия `0.5.82`: frontend CSS изолирован корнем чата и защищён selector-аудитом; шаблонные варианты приветствия преобразуются в одну естественную фразу по локальному времени сайта через `Chat\GreetingResolver`.
