...
Версия `0.5.80`: все провайдеры получили единые правила естественной речи без длинных тире и LLM-клише, а свернутый launcher получил настраиваемые доступные анимации.
