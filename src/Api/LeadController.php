		...
		if ( ! $saved ) {
			...
			return new \WP_Error(
				...
				array(
					...
					'sql_fragment' => function_exists( 'mb_substr' ) ? mb_substr( \DiasMazhenov\WPDsAiChatbot\Data\LeadRepository::$last_sql, 0, 600 ) : substr( \DiasMazhenov\WPDsAiChatbot\Data\LeadRepository::$last_sql, 0, 600 ),
				)
			);
		}
