...
use DiasMazhenov\WPDsAiChatbot\Api\ReengageController;
...
final class Plugin {
	...
	public function boot(): void {
		...
		$qa_parser      = new QuickReplyParser();
		$chat_api       = new ChatController( $tokens, $rate_limiter, $request_lock, $qa_parser );
