...
final class Settings {
	...
	public function register(): void {
		...
		$this->add_field( 'conversation_email_enabled', __( 'Dialogs without a request', 'wp-ds-aichatbot' ), 'checkbox', 'wpdsac_leads' );
	...
	public function sanitize( $input ): array {
		...
		$settings = array(
			...
			'conversation_email_enabled'       => ! empty( $input['conversation_email_enabled'] ),
	...
	public function render_page(): void {
		...
		<div class="wrap wpdsac-settings-wrap">
			...
			<form action="options.php" method="post" data-wpdsac-settings-form>
				...
				<?php $this->render_tab_panel( 'appearance', $tabs['appearance'], array( 'wpdsac_appearance_colors', 'wpdsac_appearance_layout', 'wpdsac_appearance_launcher', 'wpdsac_appearance_messages', 'wpdsac_appearance_controls' ), true ); ?>
	...
	private function render_tab_panel( string $tab_id, string $title, array $section_ids, bool $include_preview = false ): void {
		...
		$section_titles = array(
			...
			'wpdsac_appearance_messages' => __( 'Message animation', 'wp-ds-aichatbot' ),
	...
	public function render_field( array $args ): void {
		...
		if ( 'email' === $args['type'] ) {
			printf(
				...
				esc_html__( 'Contact requests and conversations without a request will be sent to this address with different subjects.', 'wp-ds-aichatbot' )
			);
			return;
		}
