...
- GitHub Actions run `29856541857` для commit `c2e4a5b` завершился успешно: зелёные PHP 7.4/8.1/8.3 lint, WPCS, PHPUnit 7.4/8.3, core/Elementor integration и package artifact. Постоянное падение CI устранено.
