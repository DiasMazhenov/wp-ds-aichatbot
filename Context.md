...
- **Стили главной страницы**: пользователь сообщает о поломке CSS. Все селекторы `.wpdsac-*`, CSS-переменные на `:root` убраны в 0.5.60. Причина пока не найдена — требуется диагностика на сервере.
